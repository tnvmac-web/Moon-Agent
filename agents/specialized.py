...
from agents.base_agent import BaseAgent, AgentConfig, Tool, ReActAgent, PlanAndExecuteAgent
...
def create_researcher_agent(llm: LocalLLM) -> BaseAgent:
    ...
    tools = [
        ...
        create_tool_from_def(d) for d in get_file_tools() if d["name"] in ("read_file", "write_file", "list_files")
    ]
