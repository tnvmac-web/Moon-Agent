...
def demo_file_operations():
    ...
    responses = {
        "Create a file called hello.txt with content 'Hello, World!'": 
            'TOOL_CALL: {"name": "write_file", "arguments": {"path": "hello.txt", "content": "Hello, World!"}}',
        "Read the file hello.txt":
            'TOOL_CALL: {"name": "read_file", "arguments": {"path": "hello.txt"}}',
...
def demo_code_execution():
    ...
    responses = {
        "Calculate 2 + 2 using Python":
            'TOOL_CALL: {"name": "run_python", "arguments": {"code": "print(2 + 2)"}}',
        "Create a fibonacci function and test it":
            'TOOL_CALL: {"name": "run_python", "arguments": {"code": "def fib(n):\\n    a, b = 0, 1\\n    for _ in range(n):\\n        a, b = b, a + b\\n    return a\\n\\nprint([fib(i) for i in range(10)])"}}',
    }
...
def demo_web_search():
    ...
    responses = {
        "Search for Python 3.12 new features":
            'TOOL_CALL: {"name": "web_search", "arguments": {"query": "Python 3.12 new features", "max_results": 3}}',
    }
